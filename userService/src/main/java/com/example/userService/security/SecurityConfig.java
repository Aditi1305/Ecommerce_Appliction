...
//client hit ->http://localhost:8080/oauth2/authorize?response_type=code&client_id=client&scope=openid&redirect_uri=https://oauth.pstmn.io/v1/callback&code_challenge=4Pl3cKYaZ5X5nyLDke8dPtI69lwmE6HwuVX_heLBIt8&code_challenge_method=S256
@Configuration
@EnableWebSecurity
public class SecurityConfig {
    ...
    @Bean
    public UserDetailsService userDetailsService(HttpSecurity http){
